package java.sortvisualizer.graphic;

import javax.swing.*;
import java.awt.*;
import java.sortvisualizer.handlers.Handler;
...
public class Graphic {
    ...
    public void visualize(){
        ...
        sortBox.addItem("java.sortvisualizer.sorts.ShakerSort");
        sortBox.addItem("java.sortvisualizer.sorts.MergeSort");
        sortBox.addItem("java.sortvisualizer.sorts.ShellSort");
        sortBox.addItem("java.sortvisualizer.sorts.SelectionSort");
        sortBox.addItem("java.sortvisualizer.sorts.InsertionSort");
        sortBox.addItem("BubbleSort");
        sortBox.addItem("java.sortvisualizer.sorts.QuickSort");
        sortBox.addItem("java.sortvisualizer.sorts.StupidSort");
